...
\begin{defn}
    ...
    % fai disegni e fai anche esempio in 3 dimensioni
\end{defn}
\end{bxthm}
...
\begin{exmp}
    ...
    %anche nel caso del disegno 2 tutti i punti sono punti di frontiera. nel 3 caso sono punti di frontiera tutti i punti che giacciono sugli assi. 
\end{exmp}
...
\begin{defn}
    ...
    % Sia $x_0\in\mathbb{R}^n$. Si dice che $x_0$ è un punto di accumulazione per $A$ se in ogni cerchio di centro $x_0$, $\exists$ almeno un punto di $A$ diverso da $x_0$.
    %\begin{figure}[H]
    %    \centering
    %    \incfig[0.5\linewidth]{disegno}
    %\end{figure}
...
% Quì il disegno può uscire molto figo
\end{prop}
\end{bxthm}
